...
import { finishVoiceMessage, setIsPLayingVoiceMessage, setSpeed, setVolume } from "../../app/slices/RecorderSlice";
    ...
    return (
        <div className="recorder-field">
            <div className="recorder-bar">
                <img className="recorder-bar__toggler" src={'/shared/' + (isPlayingMessage ? 'pause' : 'play-button') + '_white.png'} alt="" onClick={() => {
                    dispatch(setIsPLayingVoiceMessage(!isPlayingMessage));
                }}/>
                <RecorderBarVolumeRange />
                <RecorderBarSpeedRange />
                <img className="recorder-bar__close-img" src="/shared/cancel.png" alt="" onClick={() => {
