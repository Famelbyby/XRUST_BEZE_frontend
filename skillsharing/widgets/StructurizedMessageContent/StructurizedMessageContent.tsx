...
const StructurizedMessageContent: React.FC<StructurizedMessageContentPropTypes> = ({message, isOnPage}) => {
    return (
        <div className={"str-message-content" + (isOnPage ? " str-message-content_paddinged" : "")}>
            {message !== undefined && 
                <div className="str-message-markdown">
                    <ReactMarkdown>
                        {message.structurized}
                    </ReactMarkdown>
                </div>
            }
            {message === undefined && 
                <div className="str-message-content__mock">
                    <div className="str-message-content__spinner">
                    </div>
                </div>
            }
        </div>
