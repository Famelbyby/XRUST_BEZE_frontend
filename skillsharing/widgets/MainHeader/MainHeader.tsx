        ...
        function handleQueryChanging() {
            ...
            if (user !== undefined) {
                if (nextQuery === '') {
                    ...
                    dispatch(GetFoundByNameUsers({userId: user.id, query: nextQuery, callback: () => {}}));
                }
            }
        }
    ...
    return (
        <div className='main-header'>
            ...
            <div className='main-header-right'>
                <input id='searching-input' type='text' value={query} placeholder='Поиск по имени' className='main-header__searching-input' onChange={(event) => setQuery(event.target.value)}/>
            </div>
        </div>
    );
};
