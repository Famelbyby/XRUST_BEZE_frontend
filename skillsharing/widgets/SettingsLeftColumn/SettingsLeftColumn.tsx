    ...
    return (
        <div className="settings-left-column">
            <div className="settings-avatar">
                ...
                {user === undefined && (
                    <div className="settings-avatar-set settings-avatar-set-mock">
                        <div className="settings-avatar-set-spinner"></div>
                    </div>
                )}
                {user !== undefined && (
                    <>
                        <div
                            className="settings-avatar-set"
                            onClick={() => {
                        ...
                        >
                            <img
                                className="settings-avatar-set__img"
                                src={
                        ...
                        {avatar.error !== undefined && (
                            <div className="settings-avatar__error">{avatar.error}</div>
                        )}
                    </>
                )}
            </div>
            <div className="settings-preferred-format">
                ...
                <select
                    className="settings-preferred-format-select"
                    ...
                    {PREFERRED_FORMAT_TYPES.map((format: CommunicationFormat) => {
                        if (user && user.preferred_format === format) {
                            return (
                                <option
                                    selected
                                    className="settings-preferred-formata-select__option"
                                    value={format}
                                    key={format}
                                >
