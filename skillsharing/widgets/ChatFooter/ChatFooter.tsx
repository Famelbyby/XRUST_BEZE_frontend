...
import {
    ...
    IUpdatingMessage,
} from '../../entity/Message/MessageTypes';
...
const ChatFooter: React.FC = () => {
    const { editingMessage, channelID, peerID } = useSelector(
                    ...
                    <div id="recorded-voice-message" className="chat-footer-recorded-voice-message">
                        {!isPlayingRecord && (
                            <img
                                ...
                                src="/shared/play-button_white.png"
                                alt="Включить"
                                onClick={() => {
                ...
                {!isRecorded && (
                    <>
                        ...
                        <input
                            ...
                            type="file"
                            className="chat-footer-controls__attachments-input"
                            multiple
                            onChange={handleAddingAttachment}
                        />
                    </>
                )}
                {isRecorded && (
