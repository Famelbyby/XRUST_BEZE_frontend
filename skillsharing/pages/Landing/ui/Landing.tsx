            ...
            <div className="landing-content-functions">
                ...
                <div className="landing-content-functions-item landing-content-functions-item_reversed">
                    ...
                    <div className="landing-content-functions-item-description">
                        ...
                        <div className="landing-content-functions-item__text">
                            Широкий спектр экспертов, хорошо разбирающихся в своём деле, ждут ваших
                            вопросов. Вы найдёте здесь всё: начиная с линейной алгебры и
                ...
                <div className="landing-content-functions-item">
                    ...
                    <div className="landing-content-functions-item-description">
                        ...
                        <div className="landing-content-functions-item__text">
                            Большую базу учебных материалов любого формата: методические материалы,
                            статьи, рефераты и другое. Каждый может опубликовать познавательный
                            материал, отправив его в личном сообщении, а мы поможем с его
                            публикацией.
                        </div>
                    </div>
                </div>
